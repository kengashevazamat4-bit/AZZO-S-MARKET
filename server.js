...
mongoose.connect(MONGODB_URI)
  ...
  .catch((err) => console.error("❌ MongoDB bazasiga ulanishda xatolik:", err));
...
app.get('/api/payment-methods', (req, res) => {
  const cards = [
    ...
    { key: 'visa', label: 'Visa', number: process.env.CARD_VISA || '4023060149068644' },
    { key: 'mastercard', label: 'Mastercard', number: process.env.CARD_MASTERCARD || '5476381751725506' },
  ].filter((c) => c.number);
